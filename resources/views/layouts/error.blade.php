        ...
        <div class="relative grid min-h-dvh lg:grid-cols-2">
            ...
            <aside class="hidden border-r border-zinc-800/70 p-10 lg:flex lg:flex-col">
                ...
                <div class="relative z-20 mt-auto max-w-md space-y-4">
                    <p class="text-xs uppercase tracking-[0.2em] text-zinc-300">System Status</p>
                    <flux:heading size="xl" class="!text-zinc-50">Command center temporarily unavailable.</flux:heading>
                    <flux:text class="!text-zinc-200">Use the status message to recover quickly and return to active operations.</flux:text>
                </div>
            </aside>
