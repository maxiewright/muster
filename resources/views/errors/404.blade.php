...
@section('content')
    <div class="flex flex-col items-center gap-5 text-center">
        <p class="text-xs uppercase tracking-[0.2em] text-slate-400 dark:text-zinc-400">Error 404</p>
        <h1 class="text-2xl font-semibold text-slate-900 dark:text-zinc-50">Page not found</h1>
        <p class="max-w-sm text-sm text-slate-600 dark:text-zinc-300">The page you are looking for does not exist or has been moved.</p>
