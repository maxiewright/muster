            ...
            @if($currentStep === 3)
                <div class="p-6 sm:p-8">
                    ...
                    <div class="mb-6 p-4 bg-gray-50 dark:bg-zinc-900 rounded-lg">
                        <h3 class="text-sm font-medium text-gray-700 dark:text-zinc-300 mb-3">Muster Summary</h3>
                ...
                <div class="px-6 sm:px-8 py-4 bg-gray-50 dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-700">
                    <div class="flex justify-between items-center">
                        ...
                        <button wire:click="submitMuster"
                                type="button"
                                wire:loading.attr="disabled"
                            ...
                            <span wire:loading.remove wire:target="submitMuster">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                            </span>
                            <span wire:loading wire:target="submitMuster">
                            ...
                            <span wire:loading.remove wire:target="submitMuster">
                                {{ $isEditing ? 'Update Muster' : 'Submit Muster' }}
                            </span>
                            <span wire:loading wire:target="submitMuster">Submitting...</span>
                        </button>
                    </div>
                </div>
            @endif
